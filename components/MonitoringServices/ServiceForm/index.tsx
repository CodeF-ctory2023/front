...
export const ServiceForm = () => {
  ...
  return (
    <article className='flex flex-col gap-4 w-full bg-black/[0.7] p-4 shadow-md fixed left-0 bottom-0 z-50 text-center'>
      {locationError && (
      ...
      <div className='flex flex-col gap-4'>
        ...
        <div className='flex flex-col gap-2 border-0 border-t-2 border-t-gray-400'>
          <h3 className='text-white mt-4'>Ver socios cercanos</h3>
