...
const PoliticasDePagoPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (isNaN(numericValue1) || numericValue1 <= 0 || numericValue1 >= 100) {
      setError1('El valor del porcentaje de socio debe ser mayor que 0 y menor que 100.');
      return;
    }

    if (isNaN(numericValue2) || numericValue2 <= 0 || numericValue2 >= 100) {
      setError2('El valor del porcentaje de impuestos debe ser mayor que 0 y menor que 100.');
      return;
    }
